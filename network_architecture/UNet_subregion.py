...
if __name__ == "__main__":
    ...
    dataset_json_file = '/data2/pyq6817/nnUNetv2/nnUNet_preprocessed/Dataset400_MultimodalPancreas/dataset.json'
    ...
    unet = get_unet_freezed_encoder()
    my_input = torch.randn(3, 1, 128, 128, 128)
    # check the number of parameters in the encoder

    my_output = unet(my_input)
